...
for(filename in files)
{
  ...
  png(out_filename, width=2000, height=2000, pointsize=30)
  r <- raster(filename)
  plot(r, col=rev(terrain.colors(99)), breaks=seq(5000, 12000, length.out=100), legend=F)
  plot(r, col=rev(terrain.colors(5)), breaks=seq(5000, 12000, length.out=6), legend.only=T)
#  plot(r, main=out_filename)
  #title(main=out_filename)
  dev.off()
}
